...
public class EntityTNTPrimed extends Entity
{
    ...
    public EntityTNTPrimed(World par1World, double par2, double par4, double par6, EntityLiving par8EntityLiving, float explosionRadius) //
    {
        this(par1World);
    ...
    public void onUpdate()
    {
        ...
        if (this.fuse-- <= 0)
        {
            ...
            {
                this.explode(this.explosionRadius );
            }
        }
        else
        {
