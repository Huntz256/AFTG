        ...
        if (par1World.getGameRules().getGameRuleBooleanValue("doFireTick"))
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    this.tryToCatchBlockOnFire(par1World, par2, par3 + 2, par4, 250 + b0, par5Random, l, DOWN );
                    this.tryToCatchBlockOnFire(par1World, par2, par3, par4 - 2, 300 + b0, par5Random, l, SOUTH);
                    this.tryToCatchBlockOnFire(par1World, par2, par3, par4 + 2, 300 + b0, par5Random, l, NORTH);
                    //
